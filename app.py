...
st.markdown(
    ...
    .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2,
    .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 {
        display: flex !important;
        align-items: center !important;
        justify-content: flex-end !important;
        height: 54px !important;
    ...
    .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2 [data-testid="stWidgetLabel"],
    .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 [data-testid="stWidgetLabel"] {
        display: none !important;
        height: 0 !important;
        margin: 0 !important;
        padding: 0 !important;
    ...
    .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2 div[role="radiogroup"],
    .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 div[role="radiogroup"] {
        display: flex !important;
        align-items: center !important;
        justify-content: center !important;
        gap: 0 !important;
    ...
    .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2 label,
    .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 label {
    ...
    .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2 label > div:first-child,
    .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 label > div:first-child { display: none !important; }
    .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2 label p,
    .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 label p {
        color: #060b3f !important;
    ...
    .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2 label:has(input:checked),
    .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 label:has(input:checked) {
        background: #060b3f !important;
    }
    .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2 label:has(input:checked) p,
    .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 label:has(input:checked) p {
...
if "gw_filter_v2" not in st.session_state:
    st.session_state["gw_filter_v2"] = ""
if "sensor_filter_v2" not in st.session_state:
    st.session_state["sensor_filter_v2"] = ""
if "graph_sensor_filter_v2" not in st.session_state:
    st.session_state["graph_sensor_filter_v2"] = ""
...
if st.session_state["theme"] == "dark":
    st.markdown(
        ...
        .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2 label p,
        .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 label p { color: #e8eaf3 !important; }
        .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2 label:has(input:checked),
        .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 label:has(input:checked) { background: #e8eaf3 !important; }
        .st-key-temp_unit_radio, .st-key-temp_unit_radio_v2 label:has(input:checked) p,
        .st-key-pressure_unit_radio, .st-key-pressure_unit_radio_v2 label:has(input:checked) p { color: #060b3f !important; }
...
def bucket_seconds_for_range(range_label):
    """Database-side graph downsampling bucket size."""
    if range_label == "H":
        return 30
    if range_label == "D":
        return 120
...
def make_title_hover_band(title, range_label="D", x_start=None, x_end=None, capture_param=None, band_height=28):
    ...
    return alt.layer(title_mark, hover_rects).properties(height=band_height, width=1050)
...
if tab == "STATUS":
    ...
    gw_filter = st.text_input("Filter gateways", key="gw_filter_v2", placeholder="Filter gateways", label_visibility="collapsed")
    ...
    sensor_filter = st.text_input("Filter sensors", key="sensor_filter_v2", placeholder="Filter sensors", label_visibility="collapsed")
